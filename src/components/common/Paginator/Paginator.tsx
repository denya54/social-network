...
return (
    <div className={styles.paginator}>
        {portionNumber > 1 &&
        <button className={styles.butt} onClick={() => {setPortionNumber((portionNumber - 1))}}>PREV</button>}
        ...
        <button className={styles.butt} onClick={()=> {setPortionNumber(portionNumber + 1)}}>NEXT</button>}
    </div>
)
}
